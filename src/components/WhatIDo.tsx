        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Crafting engaging, high-impact edits with tight pacing,
                compelling sound design, and seamless transitions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building online presence and growing engagement through strategic scheduling,
                trend research, copywriting, and visual branding.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Scheduling</div>
